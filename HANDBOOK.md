...
- **Plan-time evaluation** — blocks bad *intent* against the rendered plan, before merge. *Built and fixture-tested* (the evaluator and profiles); goes live once the deployment pipeline feeds it a real plan (ADR 0025, ADR 0020).
