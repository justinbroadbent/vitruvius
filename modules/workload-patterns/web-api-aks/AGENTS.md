...
- **DO NOT** make `policy_definition_subscription_id` optional with a `data.azurerm_subscription.current.subscription_id` default. That hides where definitions live and surprises consumers in cross-subscription deployments.
